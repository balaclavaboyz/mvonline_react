...
export default function Politica() {
    return (
        ...
        <div class="politica">
            ...
            <p>
                A sua privacidade é importante para nós. É política do mvonline
                respeitar a sua privacidade em relação a qualquer informação sua
                que possamos coletar no site mvonline, e outros sites que
            ...
            <h2>Política de Cookies mvonline</h2>
            ...
            <ul>
                <li>
                    ...
                    melhorar sua experiência. Esses cookies podem rastrear itens
                    como quanto tempo você gasta no site e as páginas visitadas,
            ...
            <p>
                ...
                informação que o mvonline oferece no site e com caráter
            ...
            <ul>
                ...
                <li>
                    ...
                    <a href="https://ondeapostar.pt/review/moosh-portugal/">
                        {" "}
                        Moosh{" "}
                    </a>
                    ), jogos de sorte e azar, qualquer tipo de pornografia
                    ilegal, de apologia ao terrorismo ou contra os direitos
                    humanos;
                </li>
                <li>
                    C) Não causar danos aos sistemas físicos (hardwares) e
                    lógicos (softwares) do mvonline, de seus fornecedores ou
